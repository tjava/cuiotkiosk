...
class User extends \Core\Model
{
    ...
    public function save()
    {
        ...
        if (empty($this->errors)) {
            ...
            $sql = 'INSERT INTO users (name, email, unique_id, password_hash, activation_hash, is_active)
                    VALUES (:name, :email, :unique_id, :password_hash, :activation_hash, :is_active)';
     ...
     * @return boolean  True if the data was updated, false otherwise
     */
    public function updateOnSwitch($on_switch)
    {

         $sql = 'UPDATE users
                SET on_switch = :on_switch';
        ...
        $stmt->bindValue(':on_switch', $on_switch, PDO::PARAM_STR);
        $stmt->bindValue(':id', $this->id, PDO::PARAM_INT);
